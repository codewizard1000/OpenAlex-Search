...
import { ChevronDown, ChevronUp, Download, FileText, ExternalLink, Quote } from 'lucide-react';
import type { OpenAlexWork } from '../types/openalex';
import { exportToXML, downloadPdf } from '../api/openalex';
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center text-sm text-gray-600">
        <span>Showing {(currentPage - 1) * perPage + 1} - {Math.min(currentPage * perPage, totalCount)} of {totalCount} results</span>
      </div>
